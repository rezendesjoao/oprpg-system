...
export function areKeysPressed(event, action) {
  ...
  return game.keybindings.get("onepiece-system", action).some(b => {
...
export function defaultUnits(type) {
  ...
  return CONFIG.DND5E.defaultUnits[type]?.[game.settings.get("onepiece-system", settingKey) ? "metric" : "imperial"];
}
...
export async function preloadHandlebarsTemplates() {
  const partials = [
    // Shared Partials
    "systems/onepiece-system/templates/shared/active-effects.hbs",
    "systems/onepiece-system/templates/apps/parts/trait-list.hbs",
    "systems/onepiece-system/templates/apps/parts/traits-list.hbs",

    // Actor Sheet Partials
    "systems/onepiece-system/templates/actors/parts/actor-classes.hbs",
    "systems/onepiece-system/templates/actors/parts/actor-trait-pills.hbs",
    "systems/onepiece-system/templates/actors/parts/actor-traits.hbs",
    "systems/onepiece-system/templates/actors/parts/actor-features.hbs",
    "systems/onepiece-system/templates/actors/parts/actor-spellbook.hbs",
    "systems/onepiece-system/templates/actors/parts/actor-warnings.hbs",
    "systems/onepiece-system/templates/actors/parts/actor-warnings-dialog.hbs",
    "systems/onepiece-system/templates/actors/parts/biography-textbox.hbs",
    "systems/onepiece-system/templates/actors/tabs/character-bastion.hbs",
    "systems/onepiece-system/templates/actors/tabs/character-biography.hbs",
    "systems/onepiece-system/templates/actors/tabs/character-details.hbs",
    "systems/onepiece-system/templates/actors/tabs/creature-special-traits.hbs",
    "systems/onepiece-system/templates/actors/tabs/npc-biography.hbs",

    // Chat Message Partials
    "systems/onepiece-system/templates/chat/parts/card-activities.hbs",
    "systems/onepiece-system/templates/chat/parts/card-deltas.hbs",

    // Item Sheet Partials
    "systems/onepiece-system/templates/items/details/details-background.hbs",
    "systems/onepiece-system/templates/items/details/details-class.hbs",
    "systems/onepiece-system/templates/items/details/details-consumable.hbs",
    "systems/onepiece-system/templates/items/details/details-container.hbs",
    "systems/onepiece-system/templates/items/details/details-equipment.hbs",
    "systems/onepiece-system/templates/items/details/details-facility.hbs",
    "systems/onepiece-system/templates/items/details/details-feat.hbs",
    "systems/onepiece-system/templates/items/details/details-loot.hbs",
    "systems/onepiece-system/templates/items/details/details-mountable.hbs",
    "systems/onepiece-system/templates/items/details/details-species.hbs",
    "systems/onepiece-system/templates/items/details/details-spell.hbs",
    "systems/onepiece-system/templates/items/details/details-spellcasting.hbs",
    "systems/onepiece-system/templates/items/details/details-starting-equipment.hbs",
    "systems/onepiece-system/templates/items/details/details-subclass.hbs",
    "systems/onepiece-system/templates/items/details/details-tool.hbs",
    "systems/onepiece-system/templates/items/details/details-weapon.hbs",
    "systems/onepiece-system/templates/items/parts/item-summary.hbs",
    "systems/onepiece-system/templates/items/parts/item-tooltip.hbs",
    "systems/onepiece-system/templates/items/parts/spell-block.hbs",

    // Field Partials
    "systems/onepiece-system/templates/shared/fields/field-activation.hbs",
    "systems/onepiece-system/templates/shared/fields/field-damage.hbs",
    "systems/onepiece-system/templates/shared/fields/field-duration.hbs",
    "systems/onepiece-system/templates/shared/fields/field-range.hbs",
    "systems/onepiece-system/templates/shared/fields/field-targets.hbs",
    "systems/onepiece-system/templates/shared/fields/field-uses.hbs",
    "systems/onepiece-system/templates/shared/fields/fieldlist.hbs",
    "systems/onepiece-system/templates/shared/fields/formlist.hbs",

    // Journal Partials
    "systems/onepiece-system/templates/journal/parts/journal-legacy-traits.hbs",
    "systems/onepiece-system/templates/journal/parts/journal-modern-traits.hbs",
    "systems/onepiece-system/templates/journal/parts/journal-table.hbs",

    // Activity Partials
    "systems/onepiece-system/templates/activity/parts/activity-usage-notes.hbs",

    // Advancement Partials
    "systems/onepiece-system/templates/advancement/parts/advancement-controls.hbs",
    "systems/onepiece-system/templates/advancement/parts/advancement-spell-config.hbs"
  ];
