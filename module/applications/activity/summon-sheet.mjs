...
export default class SummonSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/onepiece-system/templates/activity/summon-effect.hbs",
      templates: [
        ...super.PARTS.effect.templates,
        "systems/onepiece-system/templates/activity/parts/summon-changes.hbs",
        "systems/onepiece-system/templates/activity/parts/summon-profiles.hbs"
      ]
    }
  };
