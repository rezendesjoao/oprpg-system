...
export default class TransformSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/onepiece-system/templates/activity/transform-effect.hbs",
      templates: [
        ...super.PARTS.effect.templates,
        "systems/onepiece-system/templates/activity/parts/transform-profiles.hbs",
        "systems/onepiece-system/templates/activity/parts/transform-settings.hbs"
      ]
    }
  };
