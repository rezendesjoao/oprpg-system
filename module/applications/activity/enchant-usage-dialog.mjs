...
export default class EnchantUsageDialog extends ActivityUsageDialog {
  ...
  static PARTS = {
    ...super.PARTS,
    creation: {
      template: "systems/onepiece-system/templates/activity/enchant-usage-creation.hbs"
    }
  };
  ...
  async _prepareCreationContext(context, options) {
    ...
    if ( (enchantments.length > 1) && this._shouldDisplay("create.enchantment") ) {
      const existingProfile = this.activity.existingEnchantment?.flags.OnePiece?.enchantmentProfile;
