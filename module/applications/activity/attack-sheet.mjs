...
export default class AttackSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    identity: {
      template: "systems/onepiece-system/templates/activity/attack-identity.hbs",
      templates: [
        ...super.PARTS.identity.templates,
        "systems/onepiece-system/templates/activity/parts/attack-identity.hbs"
      ]
    },
    effect: {
      template: "systems/onepiece-system/templates/activity/attack-effect.hbs",
      templates: [
        ...super.PARTS.effect.templates,
        "systems/onepiece-system/templates/activity/parts/attack-damage.hbs",
        "systems/onepiece-system/templates/activity/parts/attack-details.hbs",
