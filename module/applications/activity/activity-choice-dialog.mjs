...
export default class ActivityChoiceDialog extends Application5e {
  ...
  static PARTS = {
    activities: {
      template: "systems/onepiece-system/templates/activity/activity-choices.hbs"
    }
  };
  ...
  async _prepareContext(options) {
    let controlHint;
    if ( game.settings.get("onepiece-system", "controlHints") ) {
      controlHint = game.i18n.localize("DND5E.Controls.Activity.FastForwardHint");
      controlHint = controlHint.replace(
        "<left-click>",
        `<img src="systems/onepiece-system/icons/svg/mouse-left.svg" alt="${game.i18n.localize("DND5E.Controls.LeftClick")}">`
      );
    }
