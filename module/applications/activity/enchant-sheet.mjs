...
export default class EnchantSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/onepiece-system/templates/activity/enchant-effect.hbs",
      templates: [
        "systems/onepiece-system/templates/activity/parts/enchant-enchantments.hbs",
        "systems/onepiece-system/templates/activity/parts/enchant-restrictions.hbs"
      ]
    }
  };
