...
export default class CastSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/onepiece-system/templates/activity/cast-effect.hbs",
      templates: [
        "systems/onepiece-system/templates/activity/parts/cast-spell.hbs",
        "systems/onepiece-system/templates/activity/parts/cast-details.hbs"
      ]
    }
  };
