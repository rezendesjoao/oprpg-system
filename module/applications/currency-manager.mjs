...
export default class CurrencyManager extends Application5e {
  ...
  static PARTS = {
    ...
    convert: {
      template: "systems/onepiece-system/templates/apps/currency-manager-convert.hbs"
    },
    transfer: {
      template: "systems/onepiece-system/templates/apps/currency-manager-transfer.hbs"
    }
  };
