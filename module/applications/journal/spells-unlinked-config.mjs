...
export default class SpellsUnlinkedConfig extends DocumentSheet5e {
  ...
  static PARTS = {
    spell: {
      template: "systems/onepiece-system/templates/journal/spell/unlinked-spell.hbs"
    },
    source: {
      template: "systems/onepiece-system/templates/journal/spell/unlinked-source.hbs"
    }
  };
