...
export default class JournalSpellListPageSheet extends JournalEntryPageHandlebarsSheet {
  ...
  static EDIT_PARTS = {
    ...
    config: {
      ...
      template: "systems/onepiece-system/templates/journal/spell/config.hbs"
    },
    list: {
      classes: ["right", "spell-list"],
      template: "systems/onepiece-system/templates/journal/spell/list.hbs"
    }
  };
  ...
  static VIEW_PARTS = {
    content: {
      root: true,
      template: "systems/onepiece-system/templates/journal/spell/view.hbs"
    }
  };
  ...
  _configureRenderParts(options) {
    ...
    if ( ("content" in parts) && this.options.displayAsTable ) {
      parts.content.template = "systems/onepiece-system/templates/journal/spell/table.hbs";
    }
    return parts;
  }
