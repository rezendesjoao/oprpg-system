...
export default function TargetedApplicationMixin(Base) {
  return class TargetedApplicationElement extends Base {
    ...
    buildTargetContainer() {
      ...
      if ( !this.chatMessage?.getFlag("onepiece-system", "targets")?.length ) this.targetSourceControl.hidden = true;
    ...
    buildTargetsList() {
      ...
      switch ( this.targetingMode ) {
        case "targeted":
          this.chatMessage?.getFlag("onepiece-system", "targets")?.forEach(t => targetedTokens.set(t.uuid, t.name));
          break;
        case "selected":
