...
export default class ContainerSheet extends ItemSheet5e {
  ...
  static PARTS = {
    ...super.PARTS,
    contents: {
      template: "systems/onepiece-system/templates/items/contents.hbs",
      templates: [
        "systems/onepiece-system/templates/inventory/inventory.hbs", "systems/onepiece-system/templates/inventory/encumbrance.hbs"
      ],
      scrollable: [""]
    }
  };
