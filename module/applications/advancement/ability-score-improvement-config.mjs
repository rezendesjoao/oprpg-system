...
export default class AbilityScoreImprovementConfig extends AdvancementConfig {
  ...
  static PARTS = {
    ...super.PARTS,
    details: {
      template: "systems/onepiece-system/templates/advancement/ability-score-improvement-config-details.hbs"
    },
    scores: {
      template: "systems/onepiece-system/templates/advancement/ability-score-improvement-config-scores.hbs",
      templates: ["systems/onepiece-system/templates/advancement/parts/advancement-ability-score-control.hbs"]
    }
  };
