...
export default class SubclassFlow extends AdvancementFlow {
  ...
  static PARTS = {
    ...super.PARTS,
    content: {
      template: "systems/onepiece-system/templates/advancement/subclass-flow.hbs"
    }
  };
  ...
  async _prepareContext(options) {
    const uuid = foundry.utils.getProperty(this.retainedData ?? {}, "flags.OnePiece.sourceId");
