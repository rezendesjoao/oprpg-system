...
export default class ScaleValueConfig extends AdvancementConfig {
  ...
  static PARTS = {
    ...
    details: {
      container: { classes: ["column-container"], id: "column-left" },
      template: "systems/onepiece-system/templates/advancement/scale-value-config-details.hbs"
    },
    levels: {
      container: { classes: ["column-container"], id: "column-right" },
      template: "systems/onepiece-system/templates/advancement/scale-value-config-levels.hbs"
    }
  };
