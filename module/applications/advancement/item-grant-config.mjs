...
export default class ItemGrantConfig extends AdvancementConfig {
  ...
  static PARTS = {
    ...super.PARTS,
    details: {
      template: "systems/onepiece-system/templates/advancement/item-grant-config-details.hbs"
    },
    spellConfig: {
      template: "systems/onepiece-system/templates/advancement/advancement-spell-config-section.hbs"
    },
    items: {
      template: "systems/onepiece-system/templates/advancement/item-grant-config-items.hbs"
    }
  };
