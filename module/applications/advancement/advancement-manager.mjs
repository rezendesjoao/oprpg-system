...
export default class AdvancementManager extends Application5e {
  ...
  static PARTS = {
    manager: {
      template: "systems/onepiece-system/templates/advancement/advancement-manager.hbs"
    }
  };
      ...
      do {
        ...
        if ( (type === "delete") && this.step.item ) {
          if ( this.step.flow?.retainedData?.retainedItems ) {
            this.step.flow.retainedData.retainedItems[this.step.item.flags.OnePiece?.sourceId] = this.step.item.toObject();
          }
...
class AdvancementVisualizer extends Application5e {
  ...
  static PARTS = {
    steps: {
      template: "systems/onepiece-system/templates/advancement/advancement-visualizer.hbs"
    }
  };
