...
export const JJ_CONDITIONS = [
  ...
  { id: "op-haki-inativo",     label: "Haki Inativo",      icon: "fas fa-link-slash",        desc: "Estágio Inexperiente — falhou o teste de Vontade (Haki) CD 15 no início do combate: não pode usar nenhuma forma de Haki neste encontro. Gaste uma ação, sem se mover, para repetir o teste." },
  { id: "op-haki-so-primario", label: "Só Haki Principal", icon: "fas fa-star-half-stroke",  desc: "Estágio Treinado — falhou o teste de Vontade (Haki) CD 15 no início do combate: só pode usar o seu Haki Principal neste encontro. Gaste uma ação para repetir o teste e liberar o uso completo." },
