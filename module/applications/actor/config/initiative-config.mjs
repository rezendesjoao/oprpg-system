...
export default class InitiativeConfig extends BaseConfigSheet {
  ...
  static PARTS = {
    config: {
      template: "systems/onepiece-system/templates/actors/config/initiative-config.hbs"
    }
  };
  ...
  async _preparePartContext(partId, context, options) {
    ...
    context.flags = {
      alert: {
        ...
        name: "flags.OnePiece.initiativeAlert",
        value: source.flags.OnePiece?.initiativeAlert
      }
    };
