...
export default class MultiActorSheet extends BaseActorSheet {
  ...
  async _prepareMemberPortrait(actor, context) {
    const showTokenPortrait = this.actor.getFlag("onepiece-system", "showTokenPortrait");
  ...
  static addDocumentSheetConfigOptions(app, html) {
    ...
    const showTokenPortrait = doc.getFlag("onepiece-system", "showTokenPortrait");
    const artOptions = {
    ...
    fieldset.innerHTML = `
      ...
      <div class="form-group">
        ...
        <div class="form-fields">
          <select name="flags.OnePiece.showTokenPortrait" data-dtype="Boolean">
