...
export default class GroupActorSheet extends MultiActorSheet {
  ...
  static PARTS = {
    header: {
      template: "systems/onepiece-system/templates/actors/group/header.hbs"
    },
    tabs: {
      template: "systems/onepiece-system/templates/shared/horizontal-tabs.hbs",
      templates: ["templates/generic/tab-navigation.hbs"]
    },
    members: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/onepiece-system/templates/actors/group/members.hbs",
      templates: ["systems/onepiece-system/templates/actors/group/member.hbs"],
      scrollable: [""]
    },
    inventory: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/onepiece-system/templates/actors/group/inventory.hbs",
      templates: [
    ...
    biography: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/onepiece-system/templates/actors/group/biography.hbs",
      scrollable: [""]
    }
  };
  ...
  /** @inheritDoc */
  get inventorySource() {
    const inventorySource = this.actor.getFlag("onepiece-system", "inventorySource") ?? "group";
  ...
  async _prepareHeaderContext(context, options) {
    context.showXP = game.settings.get("onepiece-system", "levelingMode") !== "noxp";
  ...
  async _prepareMemberEncumbrance(actor, context) {
    ...
    const systemUnits = game.settings.get("onepiece-system", "metricWeightUnits") ? "metric" : "imperial";
    context.encumbrance = {
      pct,
  ...
  static #onAward() {
    new Award({
      award: { savedDestinations: this.actor.getFlag("onepiece-system", "awardDestinations") },
      origin: this.actor
    }).render({ force: true });
  }
  ...
  static #onToggleInventory(event, target) {
    ...
    this.actor.setFlag("onepiece-system", "inventorySource", inventory);
  }
