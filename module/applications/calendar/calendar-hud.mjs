...
export default class CalendarHUD extends BaseCalendarHUD {
  ...
  static PARTS = {
    startButtons: {
      ...
      template: "systems/onepiece-system/templates/apps/calendar-buttons.hbs"
    },
    core: {
      classes: ["calendar-core"],
      template: "systems/onepiece-system/templates/apps/calendar-core.hbs"
    },
    endButtons: {
      classes: ["calendar-buttons"],
      template: "systems/onepiece-system/templates/apps/calendar-buttons.hbs"
  ...
  async renderCore(deltas={}) {
    const prefs = game.settings.get("onepiece-system", "calendarPreferences");
