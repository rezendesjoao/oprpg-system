...
DND5E.abilities = {
  str: {
    ...
    icon: "systems/onepiece-system/icons/svg/abilities/strength.svg"
  },
  dex: {
    ...
    icon: "systems/onepiece-system/icons/svg/abilities/dexterity.svg"
  },
  con: {
    ...
    icon: "systems/onepiece-system/icons/svg/abilities/constitution.svg"
  },
  int: {
    ...
    icon: "systems/onepiece-system/icons/svg/abilities/intelligence.svg",
    defaults: { vehicle: 0 }
  },
  wis: {
    ...
    icon: "systems/onepiece-system/icons/svg/abilities/wisdom.svg",
    defaults: { vehicle: 0 }
  },
  cha: {
    ...
    icon: "systems/onepiece-system/icons/svg/abilities/charisma.svg",
    defaults: { vehicle: 0 }
  },
  hon: {
...
DND5E.skills = {
  ...
  arc: {
    ...
    icon: "icons/magic/perception/orb-eye-scrying-purple.webp"
  },
  ath: {
  ...
  prv: {
    label: "DND5E.SkillPrv",
    ability: "cha",
    fullKey: "provocacao",
    icon: "icons/skills/social/intimidation-fist-blue.webp"
  },
  slt: {
...
DND5E.facilities = {
  ...
  orders: {
    build: {
      ...
      icon: "systems/onepiece-system/icons/svg/facilities/build.svg"
    },
    change: {
      label: "DND5E.FACILITY.Orders.change.inf",
      icon: "systems/onepiece-system/icons/svg/facilities/change.svg",
      duration: 21
    },
    craft: {
      label: "DND5E.FACILITY.Orders.craft.inf",
      icon: "systems/onepiece-system/icons/svg/facilities/craft.svg"
    },
    empower: {
      label: "DND5E.FACILITY.Orders.empower.inf",
      icon: "systems/onepiece-system/icons/svg/facilities/empower.svg"
    },
    enlarge: {
      label: "DND5E.FACILITY.Orders.enlarge.inf",
      icon: "systems/onepiece-system/icons/svg/facilities/enlarge.svg",
      basic: true
    },
    harvest: {
      label: "DND5E.FACILITY.Orders.harvest.inf",
      icon: "systems/onepiece-system/icons/svg/facilities/harvest.svg"
    },
    maintain: {
      label: "DND5E.FACILITY.Orders.maintain.inf",
      icon: "systems/onepiece-system/icons/svg/facilities/maintain.svg"
    },
    recruit: {
      label: "DND5E.FACILITY.Orders.recruit.inf",
      icon: "systems/onepiece-system/icons/svg/facilities/recruit.svg"
    },
    repair: {
      label: "DND5E.FACILITY.Orders.repair.inf",
      icon: "systems/onepiece-system/icons/svg/facilities/repair.svg",
      hidden: true
    },
    research: {
      label: "DND5E.FACILITY.Orders.research.inf",
      icon: "systems/onepiece-system/icons/svg/facilities/research.svg"
    },
    trade: {
      label: "DND5E.FACILITY.Orders.trade.inf",
      icon: "systems/onepiece-system/icons/svg/facilities/trade.svg"
    }
  },
  sizes: {
    cramped: {
...
DND5E.itemProperties = {
  ...
  concentration: {
    ...
    icon: "systems/onepiece-system/icons/svg/statuses/concentrating.svg",
  ...
  mgc: {
    ...
    icon: "systems/onepiece-system/icons/svg/properties/magical.svg",
    isPhysical: true
  },
  rch: {
  ...
  ritual: {
    ...
    icon: "systems/onepiece-system/icons/svg/items/spell.svg",
...
DND5E.currencies = {
  yen: {
    ...
    abbreviation: "฿",
    conversion: 1,
    icon: "systems/onepiece-system/icons/currency/gold.webp"
  }
};
...
DND5E.damageTypes = {
  acid: {
    ...
    icon: "systems/onepiece-system/icons/svg/damage/acid.svg",
  ...
  bludgeoning: {
    ...
    icon: "systems/onepiece-system/icons/svg/damage/bludgeoning.svg",
    isPhysical: true,
  ...
  cold: {
    ...
    icon: "systems/onepiece-system/icons/svg/damage/cold.svg",
  ...
  fire: {
    ...
    icon: "systems/onepiece-system/icons/svg/damage/fire.svg",
  ...
  force: {
    ...
    icon: "systems/onepiece-system/icons/svg/damage/force.svg",
  ...
  lightning: {
    ...
    icon: "systems/onepiece-system/icons/svg/damage/lightning.svg",
  ...
  piercing: {
    ...
    icon: "systems/onepiece-system/icons/svg/damage/piercing.svg",
    isPhysical: true,
  ...
  poison: {
    ...
    icon: "systems/onepiece-system/icons/svg/damage/poison.svg",
  ...
  psychic: {
    ...
    icon: "systems/onepiece-system/icons/svg/damage/psychic.svg",
  ...
  radiant: {
    ...
    icon: "systems/onepiece-system/icons/svg/damage/radiant.svg",
  ...
  slashing: {
    ...
    icon: "systems/onepiece-system/icons/svg/damage/slashing.svg",
    isPhysical: true,
  ...
  thunder: {
    ...
    icon: "systems/onepiece-system/icons/svg/damage/thunder.svg",
...
DND5E.encumbrance = {
  ...
  effects: {
    encumbered: {
      ...
      img: "systems/onepiece-system/icons/svg/statuses/encumbered.svg"
    },
    heavilyEncumbered: {
      name: "EFFECT.DND5E.StatusHeavilyEncumbered",
      img: "systems/onepiece-system/icons/svg/statuses/heavily-encumbered.svg"
    },
    exceedingCarryingCapacity: {
      name: "EFFECT.DND5E.StatusExceedingCarryingCapacity",
      img: "systems/onepiece-system/icons/svg/statuses/exceeding-carrying-capacity.svg"
    }
  },
  threshold: {
    encumbered: {
...
DND5E.spellcasting = {
  ...
  spell: {
    ...
    prepares: true,
    order: 20,
    img: "systems/onepiece-system/icons/spell-tiers/{id}.webp",
...
DND5E.spellSchools = {
  abj: {
    ...
    icon: "systems/onepiece-system/icons/svg/schools/abjuration.svg",
    fullKey: "abjuration",
  ...
  con: {
    ...
    icon: "systems/onepiece-system/icons/svg/schools/conjuration.svg",
    fullKey: "conjuration",
  ...
  div: {
    ...
    icon: "systems/onepiece-system/icons/svg/schools/divination.svg",
    fullKey: "divination",
  ...
  enc: {
    ...
    icon: "systems/onepiece-system/icons/svg/schools/enchantment.svg",
    fullKey: "enchantment",
  ...
  evo: {
    ...
    icon: "systems/onepiece-system/icons/svg/schools/evocation.svg",
    fullKey: "evocation",
  ...
  ill: {
    ...
    icon: "systems/onepiece-system/icons/svg/schools/illusion.svg",
    fullKey: "illusion",
  ...
  nec: {
    ...
    icon: "systems/onepiece-system/icons/svg/schools/necromancy.svg",
    fullKey: "necromancy",
  ...
  trs: {
    ...
    icon: "systems/onepiece-system/icons/svg/schools/transmutation.svg",
...
DND5E.conditionTypes = {
  bleeding: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/bleeding.svg",
    pseudo: true
  },
  blinded: {
    name: "DND5E.ConBlinded",
    img: "systems/onepiece-system/icons/svg/statuses/blinded.svg",
  ...
  burning: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/burning.svg",
  ...
  charmed: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/charmed.svg",
  ...
  cursed: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/cursed.svg",
    pseudo: true
  },
  dehydration: {
    name: "EFFECT.DND5E.StatusDehydration",
    img: "systems/onepiece-system/icons/svg/statuses/dehydration.svg",
  ...
  deafened: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/deafened.svg",
  ...
  diseased: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/diseased.svg",
    pseudo: true,
    reference: "Compendium.dnd5e.rules.JournalEntry.NizgRXLNUqtdlC1s.JournalEntryPage.oNQWvyRZkTOJ8PBq"
  },
  exhaustion: {
    name: "DND5E.ConExhaustion",
    img: "systems/onepiece-system/icons/svg/statuses/exhaustion.svg",
  ...
  falling: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/falling.svg",
  ...
  frightened: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/frightened.svg",
  ...
  grappled: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/grappled.svg",
  ...
  incapacitated: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/incapacitated.svg",
  ...
  invisible: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/invisible.svg",
  ...
  malnutrition: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/malnutrition.svg",
  ...
  paralyzed: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/paralyzed.svg",
  ...
  petrified: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/petrified.svg",
  ...
  poisoned: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/poisoned.svg",
    reference: "Compendium.dnd5e.content24.JournalEntry.phbAppendixCRule.JournalEntryPage.HWs8kEojffqwTSJz"
  },
  prone: {
    name: "DND5E.ConProne",
    img: "systems/onepiece-system/icons/svg/statuses/prone.svg",
  ...
  restrained: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/restrained.svg",
  ...
  silenced: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/silenced.svg",
    pseudo: true
  },
  stunned: {
    name: "DND5E.ConStunned",
    img: "systems/onepiece-system/icons/svg/statuses/stunned.svg",
  ...
  suffocation: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/suffocation.svg",
  ...
  surprised: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/surprised.svg",
    pseudo: true
  },
  transformed: {
    name: "EFFECT.DND5E.StatusTransformed",
    img: "systems/onepiece-system/icons/svg/statuses/transformed.svg",
    pseudo: true
  },
  unconscious: {
    name: "DND5E.ConUnconscious",
    img: "systems/onepiece-system/icons/svg/statuses/unconscious.svg",
...
DND5E.statusEffects = {
  burrowing: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/burrowing.svg",
    special: "BURROW"
  },
  concentrating: {
    name: "EFFECT.DND5E.StatusConcentrating",
    img: "systems/onepiece-system/icons/svg/statuses/concentrating.svg",
    special: "CONCENTRATING"
  },
  coverHalf: {
    name: "EFFECT.DND5E.StatusHalfCover",
    img: "systems/onepiece-system/icons/svg/statuses/cover-half.svg",
    order: 2,
  ...
  coverThreeQuarters: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/cover-three-quarters.svg",
    order: 3,
    exclusiveGroup: "cover",
    coverBonus: 5
  },
  coverTotal: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/cover-total.svg",
    order: 4,
    exclusiveGroup: "cover"
  },
  dead: {
    name: "EFFECT.DND5E.StatusDead",
    img: "systems/onepiece-system/icons/svg/statuses/dead.svg",
    special: "DEFEATED",
    order: 1,
    neverBlockMovement: true
  },
  dodging: {
    ...
    img: "systems/onepiece-system/icons/svg/statuses/dodging.svg"
  },
  ethereal: {
    name: "EFFECT.DND5E.StatusEthereal",
    img: "systems/onepiece-system/icons/svg/statuses/ethereal.svg",
    neverBlockMovement: true
  },
  flying: {
    name: "EFFECT.DND5E.StatusFlying",
    img: "systems/onepiece-system/icons/svg/statuses/flying.svg",
    special: "FLY"
  },
  hiding: {
    name: "EFFECT.DND5E.StatusHiding",
    img: "systems/onepiece-system/icons/svg/statuses/hiding.svg"
  },
  hovering: {
    name: "EFFECT.DND5E.StatusHovering",
    img: "systems/onepiece-system/icons/svg/statuses/hovering.svg",
    special: "HOVER"
  },
  marked: {
    name: "EFFECT.DND5E.StatusMarked",
    img: "systems/onepiece-system/icons/svg/statuses/marked.svg"
  },
  sleeping: {
    name: "EFFECT.DND5E.StatusSleeping",
    img: "systems/onepiece-system/icons/svg/statuses/sleeping.svg",
    statuses: ["incapacitated", "unconscious"]
  },
  stable: {
    name: "EFFECT.DND5E.StatusStable",
    img: "systems/onepiece-system/icons/svg/statuses/stable.svg"
  }
};
...
DND5E.bloodied = {
  ...
  img: "systems/onepiece-system/icons/svg/statuses/bloodied.svg",
  threshold: .5
};
...
DND5E.traits = {
  ...
  di: {
    ...
    icon: "systems/onepiece-system/icons/svg/trait-damage-immunities.svg",
  ...
  dr: {
    ...
    icon: "systems/onepiece-system/icons/svg/trait-damage-resistances.svg",
    configKey: "damageTypes"
  },
  dv: {
    labels: {
    ...
    icon: "systems/onepiece-system/icons/svg/trait-damage-vulnerabilities.svg",
    configKey: "damageTypes"
  },
  dm: {
    labels: {
  ...
  ci: {
    ...
    icon: "systems/onepiece-system/icons/svg/trait-condition-immunities.svg",
...
DND5E.defaultArtwork = {
  ActiveEffect: {
    base: "systems/onepiece-system/icons/svg/active-effects/base.svg",
    enchantment: "systems/onepiece-system/icons/svg/active-effects/enchantment.svg"
  },
  Actor: {
    character: "systems/onepiece-system/icons/svg/actors/character.svg",
    encounter: "systems/onepiece-system/icons/svg/actors/encounter.svg",
    group: "systems/onepiece-system/icons/svg/actors/group.svg",
    npc: "systems/onepiece-system/icons/svg/actors/npc.svg",
    vehicle: "systems/onepiece-system/icons/svg/actors/vehicle.svg"
  },
  Item: {
    background: "systems/onepiece-system/icons/svg/items/background.svg",
    class: "systems/onepiece-system/icons/svg/items/class.svg",
    consumable: "systems/onepiece-system/icons/svg/items/consumable.svg",
    container: "systems/onepiece-system/icons/svg/items/container.svg",
    equipment: "systems/onepiece-system/icons/svg/items/equipment.svg",
    facility: "systems/onepiece-system/icons/svg/items/facility.svg",
    feat: "systems/onepiece-system/icons/svg/items/feature.svg",
    loot: "systems/onepiece-system/icons/svg/items/loot.svg",
    race: "systems/onepiece-system/icons/svg/items/race.svg",
    spell: "systems/onepiece-system/icons/svg/items/spell.svg",
    subclass: "systems/onepiece-system/icons/svg/items/subclass.svg",
    tool: "systems/onepiece-system/icons/svg/items/tool.svg",
    weapon: "systems/onepiece-system/icons/svg/items/weapon.svg"
  }
};
