...
export function registerSystemSettings() {
  ...
  game.settings.register("onepiece-system", "systemMigrationVersion", {
  ...
  // Polymorph Settings
  game.settings.register("onepiece-system", "transformationSettings", {
    scope: "client",
    config: false,
  ...
  // Rules version
  game.settings.register("onepiece-system", "rulesVersion", {
  ...
  // Movement automation
  game.settings.register("onepiece-system", "movementAutomation", {
  ...
  game.settings.register("onepiece-system", "gridAlignedSquareTemplates", {
  ...
  // Loyalty
  game.settings.register("onepiece-system", "loyaltyScore", {
  ...
  game.settings.register("onepiece-system", "disableAdvancements", {
  ...
  game.settings.register("onepiece-system", "disableConcentration", {
  ...
  game.settings.register("onepiece-system", "autoCollapseItemCards", {
  ...
  game.settings.register("onepiece-system", "autoCollapseChatTrays", {
  ...
  game.settings.register("onepiece-system", "allowRests", {
  ...
  // Allow Polymorphing
  game.settings.register("onepiece-system", "allowPolymorphing", {
  ...
  // Allow Summoning
  game.settings.register("onepiece-system", "allowSummoning", {
  ...
  game.settings.register("onepiece-system", "metricLengthUnits", {
  ...
  game.settings.register("onepiece-system", "metricVolumeUnits", {
  ...
  // Metric Unit Weights
  game.settings.register("onepiece-system", "metricWeightUnits", {
  ...
  // Strict validation
  game.settings.register("onepiece-system", "strictValidation", {
    scope: "world",
    config: false,
    type: Boolean,
    default: true
  ...
  // Dynamic art.
  game.settings.registerMenu("onepiece-system", "moduleArtConfiguration", {
  ...
  game.settings.register("onepiece-system", "moduleArtConfiguration", {
  ...
  game.settings.registerMenu("onepiece-system", "packSourceConfiguration", {
  ...
  game.settings.register("onepiece-system", "packSourceConfiguration", {
  ...
  // Bastions
  game.settings.registerMenu("onepiece-system", "bastionConfiguration", {
  ...
  game.settings.register("onepiece-system", "bastionConfiguration", {
  ...
  // Calendar Settings
  game.settings.registerMenu("onepiece-system", "calendarConfiguration", {
  ...
  game.settings.register("onepiece-system", "calendar", {
  ...
  game.settings.register("onepiece-system", "calendarConfig", {
  ...
  game.settings.register("onepiece-system", "calendarPreferences", {
  ...
  // Combat Settings
  game.settings.registerMenu("onepiece-system", "combatConfiguration", {
  ...
  game.settings.register("onepiece-system", "autoRecharge", {
  ...
  game.settings.register("onepiece-system", "autoRollNPCHP", {
  ...
  game.settings.register("onepiece-system", "criticalDamageModifiers", {
  ...
  game.settings.register("onepiece-system", "criticalDamageMaxDice", {
  ...
  game.settings.register("onepiece-system", "initiativeDexTiebreaker", {
  ...
  game.settings.register("onepiece-system", "initiativeScore", {
  ...
  // Variant Rules
  game.settings.registerMenu("onepiece-system", "variantRulesConfiguration", {
  ...
  game.settings.register("onepiece-system", "allowFeats", {
  ...
  game.settings.register("onepiece-system", "currencyWeight", {
  ...
  game.settings.register("onepiece-system", "encumbrance", {
  ...
  game.settings.register("onepiece-system", "honorScore", {
  ...
  game.settings.register("onepiece-system", "levelingMode", {
  ...
  game.settings.register("onepiece-system", "proficiencyModifier", {
  ...
  game.settings.register("onepiece-system", "restVariant", {
  ...
  game.settings.register("onepiece-system", "sanityScore", {
  ...
  // Visibility Settings
  game.settings.registerMenu("onepiece-system", "visibilityConfiguration", {
  ...
  game.settings.register("onepiece-system", "attackRollVisibility", {
  ...
  game.settings.register("onepiece-system", "bloodied", {
  ...
  game.settings.register("onepiece-system", "challengeVisibility", {
  ...
  game.settings.register("onepiece-system", "concealItemDescriptions", {
  ...
  // Primary Group
  game.settings.register("onepiece-system", "primaryParty", {
    name: "Primary Party",
    scope: "world",
    config: false,
    default: null,
  ...
  // Control hints
  game.settings.register("onepiece-system", "controlHints", {
  ...
  game.settings.register("onepiece-system", "defaultSkills", {
...
function cacheSettings() {
  ...
  for ( const setting of game.settings.settings.values() ) {
    ...
    if ( (scope !== "world") || (namespace !== "onepiece-system") ) continue;
...
export function registerDeferredSettings() {
  game.settings.register("onepiece-system", "theme", {
  ...
  matchMedia("(prefers-color-scheme: dark)").addEventListener("change", () => {
    setTheme(document.body, game.settings.get("onepiece-system", "theme"));
  });
