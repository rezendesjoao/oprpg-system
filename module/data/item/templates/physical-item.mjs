...
export default class PhysicalItemTemplate extends SystemDataModel {
  ...
  async asGear() {
    ...
    let clone;
    const change = { "flags.OnePiece.gearSource": this.parent.uuid };
    const flags = this.parent.getFlag("onepiece-system", "gear") ?? {};
  ...
  gearPresentationData() {
    ...
    if ( flags.preserveName ) {
      const namePattern = enchantment?.flags.OnePiece?.namePattern;
