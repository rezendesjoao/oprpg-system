...
export default class WeaponData extends ItemDataModel.mixin(
  ...
  get attackModes() {
    ...
    const isLight = this.properties.has("lgt") || (this.parent.actor?.getFlag("onepiece-system", "enhancedDualWielding")
  ...
  get criticalThreshold() {
    return this.parent?.actor?.flags.OnePiece?.weaponCriticalThreshold ?? Infinity;
  }
  ...
  get proficiencyMultiplier() {
    ...
    const improvised = (this.type.value === "improv") && !!actor.getFlag("onepiece-system", "tavernBrawlerFeat");
