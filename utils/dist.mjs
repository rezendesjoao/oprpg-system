...
function compileManifest() {
  ...
  // Merge changes.
  Object.assign(systemManifest.flags.OnePiece.sourceBooks, freeManifest.flags?.dnd5e?.sourceBooks ?? {});
...
function copyCompendiumContent() {
  ...
  for ( const file of fs.readdirSync(source, { recursive: true, withFileTypes: true }) ) {
    ...
    data = data.replaceAll("modules/dnd-free-rules/icons/", "systems/onepiece-system/icons/");
